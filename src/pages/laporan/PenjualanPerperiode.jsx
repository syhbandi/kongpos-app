...
const PenjualanPerdivisi = () => {
  ...
  const hidden = (e) => {
    setFormErrors(validateHidden(src));
  };
      ...
      <form className="w-80 flex items-center" onSubmit={(e) => Search(e)}>
        ...
        <div className="relative w-full">
          ...
          <input
            ...
            placeholder="Search"
          ></input>
          <p className="text-xs text-red-600">{formErrors}</p>
        </div>
        <button
          type="submit"
...
const PenjualanPercustomer = () => {
  ...
  return (
    <>
      <div className="rounded-lg bg-white shadow-lg p-5">
            ...
            <div className="grid grid-cols-4">
              ...
              <div className="p-0 bg-white rounded-md flex items-center justify-left">
                <div className="md:flex md:items-center mb-6">
                  <div className="md:w-1/3">
                    <button
                      className="p-2 bg-stone-400 rounded-lg"
                      type="submit"
                    >
                      <i className={faDotCircle}></i>
                      Filter
        ...
        <div className="p-0 bg-white">
          <div className="grid grid-cols-2">
            <div className="p-0 bg-white rounded-md flex items-center justify-left ">
              <strong>
                <strong>Jumlah Data : {dataCount}</strong>
              </strong>
            </div>
            <div className="p-0 bg-white rounded-md flex items-center justify-end">
              {/* <ReactPaginate
                ...
                breakLabel={"..."}
                pageCount={
                  jmlRecord && jmlRecord.jumlah_record / formValues.rec
                }
                marginPagesDisplayed={2}
                pageRangeDisplayed={3}
                onPageChange={handlePageClick}
      ...
      <div className="bg-white rounded-lg shadow-lg w-full p-4"></div>
      <div className="mt-5 bg-white rounded-lg shadow-lg w-full p-4"></div>
    </>
  );
};
