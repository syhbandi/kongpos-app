...
import {
  getPembelianOrder,
  getPembelianOrderCount,
  reset,
} from "../../features/laporanPembelianOrderSlice";

const PembelianOrder = ({ jenis, sumColumn = [] }) => {
  ...
  const { data, status, message, dataCount } = useSelector(
    (state) => state.laporanPembelianOrder
  );
  ...
  const handleReset = () => {
    ...
    dispatch(getPembelianOrder(initialState));
    dispatch(getPembelianOrderCount({ ...initialState, count_stats: 1 }));
    setPage(0);
  };
  ...
  const handleFilter = (e) => {
    ...
    dispatch(getPembelianOrder({ ...formData, limit: 0 }));
    dispatch(getPembelianOrderCount({ ...formData, count_stats: 1, limit: 0 }));
    setPage(0);
  };
  ...
  const handlePaginate = (e) => {
    ...
    dispatch(getPembelianOrder({ ...formData, limit: newOffset }));
    setPage(e.selected);
  };
