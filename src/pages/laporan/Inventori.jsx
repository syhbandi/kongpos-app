...
const Inventori = ({ jenis }) => {
  ...
  const handleReset = () => {
    ...
    dispatch(getInventori(initialState));
    dispatch(getInventoriCount({ ...initialState, count_stats: 1 }));
    setPage(0);
  };
  ...
  const handleFilter = (e) => {
    ...
    dispatch(getInventori({ ...formData, limit: 0 }));
    dispatch(getInventoriCount({ ...formData, count_stats: 1, limit: 0 }));
    setPage(0);
  };
  ...
  const handlePage = (e) => {
    ...
    dispatch(
      getInventori({ ...formData, [e.target.id]: e.target.value, limit: 0 })
    );
    setPage(0);
  };
  ...
  const handleSort = (col, type) => {
    ...
    dispatch(
      getInventori({ ...formData, order_col: col, order_type: type, limit: 0 })
    );
    setPage(0);
  };
  ...
  const handlePaginate = (e) => {
    ...
    dispatch(getInventori({ ...formData, limit: newOffset }));
    setPage(e.selected);
  };
