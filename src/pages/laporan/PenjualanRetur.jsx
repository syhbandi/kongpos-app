...
import {
  getPenjualanRetur,
  getPenjualanReturCount,
  reset,
} from "../../features/laporanPenjualanReturSlice";

const PenjualanRetur = ({ jenis, sumColumn = [] }) => {
  ...
  const { data, status, message, dataCount } = useSelector(
    (state) => state.laporanPenjualanRetur
  );
  ...
  const handleReset = () => {
    ...
    dispatch(getPenjualanRetur(initialState));
    dispatch(getPenjualanReturCount({ ...initialState, count_stats: 1 }));
    setPage(0);
  };
  ...
  const handleFilter = (e) => {
    ...
    dispatch(getPenjualanRetur({ ...formData, limit: 0 }));
    dispatch(getPenjualanReturCount({ ...formData, count_stats: 1, limit: 0 }));
    setPage(0);
  };
  ...
  const handlePaginate = (e) => {
    ...
    dispatch(getPenjualanRetur({ ...formData, limit: newOffset }));
    setPage(e.selected);
  };
