...
const Pendapatan = ({ jenis }) => {
  ...
  const handleReset = () => {
    ...
    dispatch(getPendapatan(initialState));
    dispatch(getPendapatanCount({ ...initialState, count_stats: 1 }));
    setPage(0);
  };
  ...
  const handleFilter = (e) => {
    ...
    dispatch(getPendapatan({ ...formData, limit: 0 }));
    dispatch(getPendapatanCount({ ...formData, count_stats: 1, limit: 0 }));
    setPage(0);
  };
  ...
  const handlePage = (e) => {
    ...
    dispatch(
      getPendapatan({ ...formData, [e.target.id]: e.target.value, limit: 0 })
    );
    setPage(0);
  };
  ...
  const handleSort = (col, type) => {
    ...
    dispatch(
      getPendapatan({ ...formData, order_col: col, order_type: type, limit: 0 })
    );
    setPage(0);
  };
  ...
  const handlePaginate = (e) => {
    ...
    dispatch(getPendapatan({ ...formData, limit: newOffset }));
    setPage(e.selected);
  };
