...
import {
  getPembelianRetur,
  getPembelianReturCount,
  reset,
} from "../../features/laporanPembelianReturSlice";

const PembelianRetur = ({ jenis, sumColumn = [] }) => {
  ...
  const { data, status, message, dataCount } = useSelector(
    (state) => state.laporanPembelianRetur
  );
  ...
  const handleReset = () => {
    ...
    dispatch(getPembelianRetur(initialState));
    dispatch(getPembelianReturCount({ ...initialState, count_stats: 1 }));
    setPage(0);
  };
  ...
  const handleFilter = (e) => {
    ...
    dispatch(getPembelianRetur({ ...formData, limit: 0 }));
    dispatch(getPembelianReturCount({ ...formData, count_stats: 1, limit: 0 }));
    setPage(0);
  };
  ...
  const handlePaginate = (e) => {
    ...
    dispatch(getPembelianRetur({ ...formData, limit: newOffset }));
    setPage(e.selected);
  };
